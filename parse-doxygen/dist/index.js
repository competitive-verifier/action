...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const updated = yield (0, parse_1.parseFiles)(verify_files);
            const updatedJsonStr = JSON.stringify(updated);
            core.info(`output json: ${updatedJsonStr}`);
            yield fs.writeFile(verify_files_path, updatedJsonStr);
        }
        catch (error) {
...
function readDoxygen(entry) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        vf.document_attributes.document_title = (_a = match.at(2)) === null || _a === void 0 ? void 0 : _a.trim();
        return [path, vf];
    });
}
function parseFiles(verify_files) {
    return __awaiter(this, void 0, void 0, function* () {
        const entries = yield Promise.all(Object.entries(verify_files.files).map(readDoxygen));
